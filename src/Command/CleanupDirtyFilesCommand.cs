//------------------------------------------------------------------------------
// <copyright file="CleanupDirtyFilesCommand.cs" company="Company">
...
namespace VSPreCommitChecks.Command
{
    ...
    internal sealed class CleanupDirtyFilesCommand
    {
        ...
        /// </summary>
        public static CleanupDirtyFilesCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            var gitService = (IGitExt)ServiceProvider.GetService(typeof(IGitExt));

            var repository = gitService.ActiveRepositories.FirstOrDefault();
